...
const RefundBankInformation = (props) => {
  ...
  const [deleteBank, { isLoading: isAccountDeleteLoading }] = useDeleteBankMutation();
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(
          "https://apardeepsingh.pythonanywhere.com/api/user/bank-details/",
          { headers }
        );
            ...
            <>
              <Grid container spacing={2}>
                {bankAccounts.map((bankAccount) => {
                  return (
                    <Grid item xs={12} md={6} key={bankAccount.uid}>
                      <Card
                        variant="outlined"
                        sx={{
                          p: 2,
                      ...
                      >
                        ...
                        <Box textAlign="right" mt={2}>
                          {
                            isAccountDeleteLoading ? <CircularProgress sx={{width: "20px !important", height: "20px !important"}} color="error" /> : (
                ...
                <Grid item xs={12} md={6} height="270px">
                  <Card
                    variant="outlined"
                    sx={{
                      p: 3,
