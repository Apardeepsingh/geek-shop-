        ...
        {isLoading ? (
          ...
          <>
            <Box textAlign="left" pb={0} sx={{ px: { xs: 0, md: 10 }, pt: { xs: 4, md: 7 } }}>
              ...
              <Typography variant="h1" fontWeight={600} sx={{ textAlign: { xs: "center", md: "start" }, fontSize: { md: 32, xs: 26 } }}>
                Shop{" "}
                <Typography
                  component="span"
                  variant="h1"
                  sx={{ fontSize: { md: 32, xs: 26 } }}
